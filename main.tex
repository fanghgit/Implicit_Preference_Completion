...
\begin{figure*}[t!]
\centering
\subfloat[Pairwise Loss]{\includegraphics[width=.23\linewidth]{figures/ml-1mpairloss.png}}
%\subfloat[Hit Ratio(HR)@10]{\includegraphics[width=.3\linewidth]{ml-1mhit.png}}
\subfloat[NDCG@10]{\includegraphics[width=.23\linewidth]{figures/ml-1mndcg.png}}
\subfloat[Pairwise Loss]{\includegraphics[width=.23\linewidth]{figures/primalCR_1M_pairloss.png}}
%\subfloat[Hit Ratio(HR)@10]{\includegraphics[width=.3\linewidth]{.png}}
\subfloat[NDCG@10]{\includegraphics[width=.23\linewidth]{figures/primalCR_1M_ndcg.png}}
...
\subfloat[Pairwise Loss]{\includegraphics[width=.23\linewidth]{figures/ml-10mpairloss.png}}
%\subfloat[Hit Ratio(HR)@10]{\includegraphics[width=.3\linewidth]{ml-10mhit.png}}
\subfloat[NDCG@10]{\includegraphics[width=.23\linewidth]{figures/ml-10mndcg.png}}
\subfloat[Pairwise Loss]{\includegraphics[width=.23\linewidth]{figures/primalCR_10M_pairloss.png}}
\subfloat[NDCG@10]{\includegraphics[width=.23\linewidth]{figures/primalCR_10M_ndcg.png}}
...
\begin{figure*}[t!]
\centering
\subfloat[Pairwise Loss]{\includegraphics[width=.33\linewidth]{figures/CRBPRml-1mpairloss.png}}
\subfloat[Hit Ratio(HR)@10]{\includegraphics[width=.33\linewidth]{figures/CRBPRml-1mhit.png}}
\subfloat[NDCG@10]{\includegraphics[width=.33\linewidth]{figures/CRBPRml-1mndcg.png}}
...
\subfloat[Pairwise Loss]{\includegraphics[width=.33\linewidth]{figures/CRBPRml-10mpairloss.png}}
\subfloat[Hit Ratio(HR)@10]{\includegraphics[width=.33\linewidth]{figures/CRBPRml-10mhit.png}}
\subfloat[NDCG@10]{\includegraphics[width=.33\linewidth]{figures/CRBPRml-10mndcg.png}}
